...
export default function InstructorCourseCard({ course }) {
  const { title, imageUrl, price, category, createAt, reviews, enrollments } =
    course;
  ...
  return (
    <Card className="max-w-sm !p-0 overflow-hidden rounded-none duration-200 border border-[#ff000000] hover:!border-[#80808039]">
      ...
      <CardContent className="!py-4 !px-0">
        ...
        <h3 className="mb-4 mx-4 text-md font-medium text-gray-900">{title}</h3>
        ...
        <div className="flex px-4 items-center justify-between">
          ...
          <DropdownMenu>
            ...
            >
              <DropdownMenuItem
                className={
                  "hover:!bg-primary-500 !text-foreground hover:!text-white !px-4 !rounded-none cursor-pointer"
                }
              >
