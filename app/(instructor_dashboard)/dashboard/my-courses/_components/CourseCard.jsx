  ...
  return (
    <div className="flex flex-col md:flex-row bg-white  shadow-sm overflow-hidden max-w-full">
      ...
      <div className="relative w-full md:w-[352px] h-64 md:h-auto p-6">
        <Image
          src="https://plus.unsplash.com/premium_photo-1682974406904-15916a7501f1?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Course image showing people in a classroom setting"
          fill
      ...
      <div className="flex flex-col p-5 md:p-6 flex-1">
        ...
        <div className="text-sm text-gray-500 mb-2">
          <span>
            Uploaded: <span className="text-gray-700">Jan 21, 2020</span>
          </span>
          <span className="mx-3">
            Last Updated: <span className="text-gray-700">Sep 11, 2021</span>
          </span>
        </div>
          ...
          <div className="flex items-center mb-4 md:mb-0">
            <div className="relative w-12 h-12">
              <div className="absolute left-0 top-0 w-8 h-8 rounded-full overflow-hidden border-2 border-white">
                <Image
                  src="https://images.unsplash.com/flagged/photo-1573740144655-bbb6e88fb18a?q=80&w=1335&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="Kevin Gilbert"
                  width={32}
                  height={32}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center mb-4 md:mb-0">
            <div className="mr-8">
              <p className="text-xl font-normal text-gray-900">$13.99</p>
