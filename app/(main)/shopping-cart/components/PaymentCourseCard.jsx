            ...
            <div className="lg:ml-5 ml-3 flex flex-col justify-center items-end lg:gap-6 gap-3 lg:min-w-[200px]">
              <div className="flex lg:space-x-3 space-x-2">
                <button
                  ...
                  className={`inline-flex items-center px-3 py-2 md:px-10 md:py-3 border border-transparent text-md font-normal lg:font-medium  text-primary-500 ${wishlist.includes(course.id)
                    ? "bg-white"
                    : "bg-primary-100"
