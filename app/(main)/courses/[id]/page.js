      ...
      <div className="w-full min-h-screen relative">
        ...
        <div className="flex-1 px-10 py-2 flex gap-6 w-[1320px] mx-auto  bg-transparent -mt-[330px] ">
          <div className="flex flex-col  gap-4 w-full">
            <Breadcrumb category={course.category} subCategory={course.subCategory}/>
            ...
            <CourseDetails tergetAudience={course?.targetAudiences} requirements={course?.PreRequirement} />
