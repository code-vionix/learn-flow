...
function FAQsPage() {
      ...
      "Getting Started": [
        {
          ...
          answer:
            'Creating an account is simple. Click the "Sign Up" button, select "Student", and follow the prompts to enter your information.',
        },
        {
          question: "What are the system requirements?",
          answer:
            "Our platform works best on modern browsers like Chrome, Firefox, Safari, or Edge. Make sure your browser is up to date.",
        },
      ],
      "Course Access": [
        {
          ...
          answer:
            'Browse our course catalog, select your desired course, and click "Enroll". You can pay using various payment methods.',
        },
        {
          question: "Can I access courses offline?",
          answer:
            "Yes, you can download course materials for offline viewing using our mobile app.",
        },
      ],
    },
    instructor: {
      "Course Creation": [
        {
          ...
          answer:
            'Click on "Create Course" in your dashboard, fill in the course details, and start adding your content modules.',
        },
        {
          question: "What file formats are supported?",
          answer:
            "We support video (MP4, WebM), audio (MP3, WAV), documents (PDF, DOCX), and presentations (PPT, PPTX).",
        },
      ],
      "Content Management": [
        {
          ...
          answer:
            "Use modules and sections to organize your content. You can drag and drop to reorder items.",
        },
        {
          question: "Can I schedule content release?",
          answer:
            "Yes, you can set specific dates for content to become available to students.",
        },
      ],
    },
  };
  ...
  const {
    data: faqCategory,
    isLoading: faqCategoryLoading,
    isError: faqCategoryError,
  } = useGetFaqByRoleQuery(role);
