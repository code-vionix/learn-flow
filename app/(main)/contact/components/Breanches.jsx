...
function Breanches() {
  ...
  return (
    <div className="  w-full px-2 py-5 sm:px-8 md:px-16 xl:px-32 2xl:px-72 md:py-20 flex flex-col items-center justify-center md:gap-10 gap-3">
      <div className="text-center flex flex-col gap-5 md:w-[37.75rem]">
        <h1 className="font-semibold text-gray-900 text-3xl lg:text-4xl">
          Our branches all over the world.
        </h1>
        <p className="font-normal text-lg lg:text-xl text-gray-700 text-center ">
      ...
      <div className="flex flex-wrap gap-6 items-center justify-center ">
        {bransheInfo.map((branche) => {
          return (
            <div
              key={branche.id}
              className=" relative flex gap-3 h-[22.75rem] cursor-pointer  "
            >
              <Image
                src={branche.image}
                alt=""
