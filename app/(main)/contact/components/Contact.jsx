...
function Contact() {
  return (
    <div className="w-full flex flex-col-reverse lg:flex-row px-2 py-4 sm:px-8 md:px-16 md:py-10 items-center justify-center gap-5">
      <div className="w-full lg:flex-none 2xl:flex-1 flex flex-col gap-5 text-center lg:text-start ">
