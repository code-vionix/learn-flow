  ...
  return (
    <div className="h-full w-full">
      <div className="w-full min-h-screen relative">
        <div className="flex flex-col  absulate top-0 h-[400px] w-full bg-gray-100"></div>

        <div className="flex-1 px-10 py-2 flex gap-6 w-[1320px] mx-auto  bg-transparent -mt-72 ">
