import { BarChart2, BookOpen, Camera, Monitor, Users } from "lucide-react";
...
export const bestSellingCourses = [
  ...
  },
  {
    ...
    students: "265.7K",
    image:
      "https://images.unsplash.com/photo-1553877522-43269d4ea984?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80",
  },
];
export const categories = [
  {
    ...
    bgColor: "rgba(238, 130, 238, 0.2)", // violet
  ...
  },
  {
    ...
    bgColor: "rgba(160, 32, 240, 0.2)", // purple
  ...
  },
  {
    ...
    bgColor: "rgba(255, 255, 0, 0.2)", // yellow
  ...
  },
  {
    ...
    title: "Photography & Video",
    courses: "6,196 Courses",
    bgColor: "rgba(255, 192, 203, 0.2)", // pink
    textColor: "text-yellow-600",
  },
];
...
export const recentCourses = [
  ...
  },
  {
    ...
    description: [
      ...
      "Master JavaScript fundamentals: variables, if/else, operators, boolean logic, functions, arrays, objects, loops, strings, etc.",
    ],
  },
  {
    id: 3,
    title: "Digital Marketing Mastery: Complete Marketing Course",
    category: {
      name: "Marketing",
      color: "#342F98",
      bgColor: "#EBEBFF",
    ...
    instructor: {
      name: "Michael Brown",
      image:
        "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=100&h=100&q=80",
    },
    level: "Intermediate",
    duration: "10 hour",
    description: [
      ...
      "Learn to use marketing tools and techniques effectively",
    ],
  },
];
